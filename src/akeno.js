...
module.exports = (() => {
	try {
		return require('./akeno_' + process.platform + '_' + process.arch + '_' + process.versions.modules + '.node');
	} catch (e) {
		throw new Error('This version of akeno.uws.js (uWebSockets v20.67.0) supports only Node.js versions 20, 22, 24 and 26 on (glibc) Linux, macOS and Windows, on Tier 1 platforms (https://github.com/nodejs/node/blob/master/BUILDING.md#platform-list).\n\n' + e.toString());
	}
})();
